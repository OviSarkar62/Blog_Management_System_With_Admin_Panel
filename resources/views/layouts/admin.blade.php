...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('storage/user/1698157701.jfif') }}" class="img-circle elevation-2" alt="Admin">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('home.index') }}" class="nav-link {{ (request()->is('admin/dashboard')) ? 'active': '' }}">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <a href="https://github.com/OviSarkar62">Ovi Sarkar</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
